from solver_utils import get_feedback, filter_candidates, calculate_color_probabilities, all_candidates, CODE_LENGTH, COLORS

def greedy_solver(secret_code, max_attempts=10):
